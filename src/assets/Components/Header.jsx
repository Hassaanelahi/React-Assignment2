                    ...
                    <Grid container spacing={2}>
                        <Grid xs={12} md={5}>
                            <Stack spacing={5}>
                                <Typography
                                    variant="h2"
                                    sx={{ fontFamily: 'Barlow, sans-serif', fontWeight: 'bolder', color: '#212b36' }}>
                                ...
                                <Stack>
                                    <Typography
                                        variant="p"
                                        sx={{ fontFamily: 'Public Sans, sans-serif', fontWeight: '700', color: '#212B36', fontSize: '0.75rem', opacity: '0.48', mb: '2px' }}>
                                        AVAILABLE FOR
                                    </Typography>
